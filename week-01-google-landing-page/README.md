# Week 1: Google Landing Page

This project is a recreation of the Google landing page using HTML and CSS.
...
1. **Open the Project in VS Code**:
   ...
   - Go to `File` > `Open Folder...` and select the `week-01-google-landing-page` folder.
...
This will display the Google landing page recreation in your browser.